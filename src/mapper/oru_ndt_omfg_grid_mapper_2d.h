#ifndef CSLIBS_MAPPING_ORU_NDT_OMFG_GRID_MAPPER_2D_H
#define CSLIBS_MAPPING_ORU_NDT_OMFG_GRID_MAPPER_2D_H
...
namespace mapper {
class OruNDTOMFGGridMapper2D : public Mapper
{
public:
    virtual ~OruNDTOMFGGridMapper2D();
...
#endif // CSLIBS_MAPPING_ORU_NDT_OMFG_GRID_MAPPER_2D_H
