#ifndef CSLIBS_MAPPING_ORU_NDT_OM_GRID_MAPPER_2D_H
#define CSLIBS_MAPPING_ORU_NDT_OM_GRID_MAPPER_2D_H
...
namespace mapper {
class OruNDTOMGridMapper2D : public Mapper
{
public:
    virtual ~OruNDTOMGridMapper2D();
...
#endif // CSLIBS_MAPPING_ORU_NDT_OM_GRID_MAPPER_2D_H
