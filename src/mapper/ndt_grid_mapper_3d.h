...
/*
        ...
        std::cout << "[NDTGridMapper3D]: traversal N | mean | std [ms] || traversal normalized mean | std [ns] = \n"
                  ...
                  << std::endl;
        std::cout << "[NDTGridMapper3D]: traversal mean [ms] | traversal normalized mean [ns] = \n"
...
//                cells.clear();
        ...
        std::cout << "[NDTGridMapper3D]: access N | mean | std [ns] = \n"
                  ...
                  << std::endl;
        std::cout << "[NDTGridMapper3D]: access mean [ns] = \n"
